...
run_test() {
  ...
  (cd tests && $entry -m pytest --benchmark-disable -v --import-mode=append --timeout=1200 --forked --numprocesses=auto --dist loadfile $(find . -type f \( -iname "test_*.py" ! \( -iname "test_standalone_*.py" \) \)))
